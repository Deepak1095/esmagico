...
const AboutSession = () => {
    return (
        <div className=' mb-8 md:mb-44 md:mt-24 mt-44'>
            <p className=' text-[20px] md:text-[40px] font-semibold m-auto w-full text-center md:w-1/3 mt-96 md:mt-44 '>Why Curate Your Own Sessions?</p>
